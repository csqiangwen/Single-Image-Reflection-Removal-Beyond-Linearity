...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='reflection_synthesis', help='name of the experiment. It decides where to store samples and models')
    ...
    def parse(self):
        ...
        self.opt.checkpoints_dir = self.opt.checkpoints_dir
